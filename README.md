...
| Id           | Student Name   | StudentType  | Major|  Company |  JobTitle  |  GroupNo |
|--------------|----------------|--------------| -----| ---------|------------|----------|
| 1            | Fatima Ali     |     I        |  CS  |          |            |          |
| 2            | Noor Saleh     |     C        |      |   ABC    |  Developer |   G01    |
| 3            | Omar Youssef   |     I        |  BIS |          |            |          |
| 4            | Huda Ahmed     |     C        |      |   EFG    |  Developer |   G02    |
| 5            | Amira Tariq    |     I        |  CS  |          |            |          |
| 6            | Zainab Ismail  |     I        |  CS  |          |            |          |
| 7            | Yousef Farid   |     C        |      |   ABC    |   BA       |   G01    |
...
| Id    | Company |  JobTitle | GroupNo | ParticipantId |
|-------|---------|-----------|---------|---------------|
